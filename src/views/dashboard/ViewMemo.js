...
const ViewMemo = () => {
    ...
    const getMemoDetails = () => {
        CreditMemoServices.getMemoList("dash_page", 0, 999, "", null, null, -1)
            .then(response => {
    ...
    return (
        <>
            ...
            <div ref={componentRef} style={{ padding: '40px', fontSize: '0.8em' }}>
                <div id="memo-to-export" style={{ minHeight: "500px", maxHeight: "500px" }}>
                    <CRow className='ms-2 mb-1' style={{ overflow: 'scroll' }}>
                            ...
                            <CCol className='d-flex justify-content-end'>
                                <CRow>
                                    <CCol>
                                        ...
                                        <p style={{ fontWeight: "bold", padding: 0, margin: 0, textAlign: 'end' }}>Memo Ref# {creditMemo?.ref_no}</p>
                                    </CCol>
                        ...
                        <CRow>
                            <CCol md={6}>
                                ...
                                <span>{creditMemo?.invoice_returned_remarks}.</span>
