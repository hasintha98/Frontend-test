                ...
                <CTable striped>
                    ...
                    <CTableBody>
                        <CTableRow>
                            ...
                            <CTableHeaderCell scope="row" className='text-center'>#CM451-1</CTableHeaderCell>
                            ...
                            <CTableDataCell className='text-center'>Refund Pending</CTableDataCell>
                            <CTableDataCell className='text-center'>LKR 201,500</CTableDataCell>
                            <CTableDataCell className='d-flex justify-content-around'>
                                <span className="material-symbols-outlined" style={{ cursor: "pointer" }} onClick={() => navigate('/memos/view?memoId=CM451-1')}>
                                    visibility
                                </span>
                            </CTableDataCell>
                        </CTableRow>
